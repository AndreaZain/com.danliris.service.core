...
//{
//	public class GarmentSupplierService : BasicService<CoreDbContext, GarmentSupplier>, IBasicUploadCsvService<GarmentSupplierViewModel>
//		//, IMap<GarmentSupplier, GarmentSupplierViewModel>
//	{
//		private const string UserAgent = "core-product-service";
//		private readonly IdentityService identityService;
//		private readonly DbSet<GarmentSupplier> _DbSet;
...
//		public GarmentSupplierService(IServiceProvider serviceProvider, CoreDbContext dbContext, IIdentityService iIdentityService) : base(serviceProvider)
//		{
//			_dbContext = dbContext;
//			_DbSet = _dbContext.Set<GarmentSupplier>();
...
//			GarmentSupplierVM.DocumentsFile = GarmentSupplier.DocumentsFile;
//            GarmentSupplierVM.DocumentsPath = new List<string> { GarmentSupplier.DocumentsPath };
//            GarmentSupplierVM.DocumentsFileName = new List<string> { GarmentSupplier.DocumentsFileName };

//            return GarmentSupplierVM;
//		}
//		public async Task<GarmentSupplier> MapToModel(GarmentSupplierViewModel GarmentSupplierVM)
//		{
...
//            GarmentSupplier.DocumentsFile = GarmentSupplierVM.DocumentsFile;           
//            GarmentSupplier.DocumentsFileName = GarmentSupplierVM.DocumentsFileName.FirstOrDefault();

//            //GarmentSupplier.DocumentsPath = GarmentSupplierVM.DocumentsPath.FirstOrDefault();

//            GarmentSupplier.DocumentsPath = await AzureDocumentFacade.UploadMultipleFile(GarmentSupplier.GetType().Name, (int)GarmentSupplier.Id, GarmentSupplier._CreatedUtc, GarmentSupplier.DocumentsFile, GarmentSupplier.DocumentsFileName, GarmentSupplier.DocumentsPath);
